...
# The data is uploaded daily for each of the routes, this is why the count is twice as much as the days in each 
month. 
...
rides_per_station_per_month = quarterly_rides.groupby(['from_station_name', 'year_month']).size().reset_index
(name='ride_count')
